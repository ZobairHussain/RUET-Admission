...
require_once('../db.php');
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO `admin` (`email`, `password`, `name`, `dept`) VALUES ('$email', '$pass', '$name', '$dept')";
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin animated shake" method="post" action="">
        <h2 class="form-signin-heading">Admin Sign Up</h2>
        ...
        <input name="dept" type="text" id="inputdept" class="form-control" placeholder="Department" required autofocus>
