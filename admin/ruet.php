...
if(isset($_POST['submit'])) {
    if(empty($_POST['id']) || empty($_POST['phy']) || empty($_POST['che']) || empty($_POST['math']) || empty($_POST['eng'])) {
        ...
        $sql = "INSERT INTO `ruet_result` (`user_id`, `physics`, `chemistry`, `math`, `english`) VALUES ('$id', '$phy', '$che', '$math', '$eng')";
...
<!-- Form Name -->
<legend align="center">Insert Student's RUET Admission Result</legend>
